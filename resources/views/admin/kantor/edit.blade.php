            ...
            <div class="tile-body">
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" name="nama_kantor" class="form-control {{ $errors->has('nama_kantor') ? 'is-invalid' : '' }}" value="{{ $kantor->nama_kantor }}" placeholder="Masukkan Nama kantor">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select name="id_grup" class="form-control {{ $errors->has('id_grup') ? 'is-invalid' : '' }}">
                            ...
                            <option value="{{ $data->id_grup }}" {{ $kantor->id_grup == $data->id_grup ? 'selected' : '' }}>{{ $data->nama_grup }}</option>
                            @endforeach
                        </select>
